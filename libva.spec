...
Version  : 2.10.0
Release  : 44
URL      : https://github.com/intel/libva/archive/2.10.0/libva-2.10.0.tar.gz
Source0  : https://github.com/intel/libva/archive/2.10.0/libva-2.10.0.tar.gz
...
%prep
%setup -q -n libva-2.10.0
cd %{_builddir}/libva-2.10.0
pushd ..
cp -a libva-2.10.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610309795
...
cp %{_builddir}/libva-2.10.0/COPYING %{buildroot}/usr/share/package-licenses/libva/099b1aff1b937aad419a0cc7cfb474d2d74acf0b
pushd ../build32/
...
/usr/lib64/libva-drm.so.2.1000.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.1000.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.1000.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.1000.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.1000.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.1000.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.1000.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.1000.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.1000.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.1000.0
