...
Version  : 2.9.0.pre2
Release  : 44
URL      : file:///insilications/build/clearlinux/packages/libva/libva-2.9.0.pre2.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/libva/libva-2.9.0.pre2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600594703
