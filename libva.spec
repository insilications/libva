...
Source0  : https://github.com/intel/libva/archive/2.5.0.tar.gz
...
%prep
%setup -q -n libva-2.5.0
pushd ..
cp -a libva-2.5.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1562799777
export GCC_IGNORE_WERROR=1
export AR=gcc-ar
export RANLIB=gcc-ranlib
export NM=gcc-nm
export CFLAGS="$CFLAGS -O3 -falign-functions=32 -ffat-lto-objects -flto=44 -fno-math-errno -fno-semantic-interposition -fno-trapping-math "
export FCFLAGS="$CFLAGS -O3 -falign-functions=32 -ffat-lto-objects -flto=44 -fno-math-errno -fno-semantic-interposition -fno-trapping-math "
export FFLAGS="$CFLAGS -O3 -falign-functions=32 -ffat-lto-objects -flto=44 -fno-math-errno -fno-semantic-interposition -fno-trapping-math "
export CXXFLAGS="$CXXFLAGS -O3 -falign-functions=32 -ffat-lto-objects -flto=44 -fno-math-errno -fno-semantic-interposition -fno-trapping-math "
...
/usr/lib32/libva-drm.so.2.500.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.500.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.500.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.500.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.500.0
