...
Source0  : https://github.com/intel/libva/releases/download/2.2.0/libva-2.2.0.tar.bz2
Summary  : Userspace Video Acceleration (VA) core interface
Group    : Development/Tools
License  : MIT
Requires: libva-lib
Requires: libva-license
...
%prep
%setup -q -n libva-2.2.0
pushd ..
cp -a libva-2.2.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1531401923
export AR=gcc-ar
...
export SOURCE_DATE_EPOCH=1531401923
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libva
cp COPYING %{buildroot}/usr/share/doc/libva/COPYING
pushd ../build32/
%make_install32
...
/usr/lib64/libva-drm.so.2.200.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.200.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.200.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.200.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.200.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.200.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.200.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.200.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.200.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.200.0
