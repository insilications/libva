...
Version  : 2.9.0
Release  : 43
URL      : https://github.com/intel/libva/archive/2.9.0/libva-2.9.0.tar.gz
Source0  : https://github.com/intel/libva/archive/2.9.0/libva-2.9.0.tar.gz
...
%prep
%setup -q -n libva-2.9.0
cd %{_builddir}/libva-2.9.0
pushd ..
cp -a libva-2.9.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600449673
...
cp %{_builddir}/libva-2.9.0/COPYING %{buildroot}/usr/share/package-licenses/libva/099b1aff1b937aad419a0cc7cfb474d2d74acf0b
pushd ../build32/
