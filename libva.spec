...
Source0  : https://github.com/01org/libva/releases/download/1.8.3/libva-1.8.3.tar.bz2
...
%prep
%setup -q -n libva-1.8.3
pushd ..
cp -a libva-1.8.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1498660089
export AR=gcc-ar
