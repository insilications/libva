...
%prep
%setup -q -n libva-2.1.0
pushd ..
cp -a libva-2.1.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1525307767
export AR=gcc-ar
...
/usr/lib64/libva-drm.so.2.100.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.100.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.100.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.100.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.100.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.100.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.100.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.100.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.100.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.100.0
