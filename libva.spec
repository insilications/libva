...
Source0  : https://github.com/01org/libva/releases/download/2.0.0/libva-2.0.0.tar.bz2
...
%prep
%setup -q -n libva-2.0.0
pushd ..
cp -a libva-2.0.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1508618833
export AR=gcc-ar
...
/usr/lib32/libva-drm.so.2.0.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.0.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.0.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.0.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.0.0
