...
%prep
%setup -q -n libva-2.4.0
pushd ..
cp -a libva-2.4.0 build32
popd
...
/usr/lib64/libva-drm.so.2.400.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.400.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.400.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.400.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.400.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.400.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.400.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.400.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.400.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.400.0
