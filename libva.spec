...
Version  : 2.3.0
Release  : 32
URL      : https://github.com/intel/libva/archive/2.3.0.tar.gz
Source0  : https://github.com/intel/libva/archive/2.3.0.tar.gz
...
%description
Video Acceleration (VA) API interface
...
%prep
%setup -q -n libva-2.3.0
pushd ..
cp -a libva-2.3.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1538502236
export AR=gcc-ar
...
/usr/lib64/libva-drm.so.2.300.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.300.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.300.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.300.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.300.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.300.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.300.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.300.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.300.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.300.0
