...
Version  : 2.6.0.pre1
Release  : 41
URL      : https://github.com/intel/libva/archive/2.6.0.pre1.tar.gz
Source0  : https://github.com/intel/libva/archive/2.6.0.pre1.tar.gz
...
%prep
%setup -q -n libva-2.6.0.pre1
pushd ..
cp -a libva-2.6.0.pre1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571263264
...
cp %{_builddir}/libva-2.6.0.pre1/COPYING %{buildroot}/usr/share/package-licenses/libva/099b1aff1b937aad419a0cc7cfb474d2d74acf0b
pushd ../build32
